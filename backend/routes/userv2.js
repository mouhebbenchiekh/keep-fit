// TODO : use this if the other auth didn't work and add another user schema and route
...
router.get('/', auth.required, function(req, res, next) { // remove auth
...
router.post('/facility/login', function(req, res, next) {
	if (!req.body.user) {
		return res.sendStatus(400);
	}
	if (!req.body.user.email) {
